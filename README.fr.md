...
- **Comprendre cet écran** — Lumen capture l'écran réel et le fait décrire par le modèle vision actif. Tracez un rectangle pour n'interroger qu'une zone plutôt que tout l'écran.
